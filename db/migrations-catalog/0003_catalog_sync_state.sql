-- media_catalog migration 0003: sync operational state.
--
...
-- database must never cost the catalog its cursor (and vice versa). The
-- reelhouse database's sync_cursor table (RH-0003) remains for jobs that
-- reconcile household-owned state.
--
