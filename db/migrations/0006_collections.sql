-- RH-0027 migration 0006: curated collections and their items.
-- Collections are household-level curation, not per-profile state. Their
-- creator is recorded as provenance only: ON DELETE SET NULL so deleting a
-- profile never destroys the household's collections.
