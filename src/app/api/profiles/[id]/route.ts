...
import { deleteProfile, getProfile, updateProfile } from "@/lib/household/store.ts";
import { parseProfilePatch, parseUuid } from "@/lib/household/validate.ts";
...
// Deletion cascades to this profile's preferences, watch state, playback
// history, and Jellyfin link — ReelHouse-owned household state only; no
// Jellyfin data and no media_catalog rows are touched.
