...
import { createProfile, listProfiles } from "@/lib/household/store";
import {
  HOUSEHOLD_LIMITS,
  parseBooleanQuery,
  parseDisplayName,
...
// GET /api/profiles?includeInactive=1&limit= — bounded, deterministic read.
...
// POST /api/profiles { displayName, preferences? }
